...
$(call inherit-product, $(COMMON_VENDOR_PATH)/melius-common-vendor.mk)
...
# Etc scripts
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/rootdir/vendor/etc/init.qcom.audio.sh:$(TARGET_COPY_OUT_VENDOR)/etc/init.qcom.audio.sh \
    $(COMMON_PATH)/rootdir/vendor/etc/init.qcom.bt.sh:$(TARGET_COPY_OUT_VENDOR)/etc/init.qcom.bt.sh
