...
LINEEND=" \\"
COUNT=`wc -l ../melius-common/proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../melius-common/proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
FIRST=1
...
LINEEND=" \\"
COUNT=`wc -l ../melius-common/common-proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../melius-common/common-proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
